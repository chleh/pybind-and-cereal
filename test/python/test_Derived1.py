...
import REFLECT_LIB_INTERNAL__AUX as aux
...
class TestDerived1(unittest.TestCase):
    ...
    def test_member_vector(self):
        ...
        type_name = "std::vector<float, std::allocator<float> >"
        self.assertIs(types_one.all_types[type_name], aux.aux_types[type_name])

        v = types_one.all_types[type_name]([1,2,3])
